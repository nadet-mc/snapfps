...
public class ConfigManager {
    ...
    private static File getFilePath() {
        Path path = Paths.get(FabricLoader.getInstance().getConfigDir().toString(), SnapFPSMod.MOD_ID + ".json");
    ...
    public static ConfigData loadConfig() {
        try {
            ...
            LOGGER.info("[" + SnapFPSMod.MOD_ID + "] " + "Couldn't load configuration file, reverting to defaults!");
        } catch (Exception ex) {
            LOGGER.info("[" + SnapFPSMod.MOD_ID + "] " + "Couldn't load configuration file, reverting to defaults!");
            ex.printStackTrace();
        }
    ...
    public static void saveConfig() {
        try {
            ...
            LOGGER.info("[" + SnapFPSMod.MOD_ID + "] " + "Couldn't save configuration file.");
            e.printStackTrace();
        }
    }
}