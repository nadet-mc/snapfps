...
public class FallbackOptionScreen extends Screen {
    ...
    public FallbackOptionScreen(Screen parent) {
        super(Text.translatable("text.snapfps.options.fallback_title"));
        this.parent = parent;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(this.textRenderer, Text.translatable("text.snapfps.options.fallback_message"), this.width / 2, this.height / 2, 0xFFFFFF);
    }
